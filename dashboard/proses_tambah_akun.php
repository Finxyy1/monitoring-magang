...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Jika validasi oke, simpan ke DB
    if (!$errors) {
            ...
            <div class="form-container fade-in">
                <?php if ($success): ?>
                    <div class="success-container">
                        ...
                        <h4 class="success-title">Akun Berhasil Ditambahkan!</h4>
                        <p class="success-message">Akun baru telah berhasil dibuat dalam sistem.</p>
                        <div class="form-actions">
                            <a href="proses_tambah_akun.php" class="btn btn-success">
                                <i class="fas fa-plus"></i> Tambah Akun Lagi
                            </a>
                ...
                <?php else: ?>
                    <div class="form-header">
                        <h4>Buat Akun Pengguna Baru</h4>
                        <p>Isi form di bawah ini untuk membuat akun pengguna baru dalam sistem.</p>
                    </div>
                    ...
                    <form action="" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                            ...
                            <select id="role" name="role" required>
                                ...
                                <option value="mahasiswa" <?= (($_POST['role'] ?? '') === 'mahasiswa') ? 'selected' : '' ?>>
                                    Mahasiswa
                                </option>
                                <option value="mitra" <?= (($_POST['role'] ?? '') === 'mitra') ? 'selected' : '' ?>>
                                    Mitra Industri
                                </option>
                                <option value="dosen" <?= (($_POST['role'] ?? '') === 'dosen') ? 'selected' : '' ?>>
                                    Dosen Pembimbing
                                </option>
                            </select>
                        </div>
